...
const socialLinks = [
	{
		...
		svg: (
			<svg viewBox="0 0 16 16" aria-hidden="true" className="h-6 w-6" fill="currentColor">
...
const Header = ({ currentPath }: HeaderProps) => (
	<header className="bg-white shadow-soft">
		<nav className="mx-auto flex max-w-content flex-wrap items-center gap-3 px-4 py-3">
			<h2 className="mr-auto text-lg font-bold text-ink">
